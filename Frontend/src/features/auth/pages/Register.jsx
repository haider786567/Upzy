...
const Register = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#FBE4D8] flex items-center justify-center relative overflow-hidden font-['Inter',sans-serif]">
      ...
      <div className="absolute top-[10%] right-[-10%] w-[500px] h-[500px] bg-[#DFB6B2]/30 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[10%] left-[-10%] w-[600px] h-[600px] bg-[#854F6C]/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="hidden md:flex flex-col items-center justify-center relative bg-linear-to-b from-[#1A0B2E] to-[#080312] m-2 rounded-3xl overflow-hidden shadow-2xl shadow-black/40">
          ...
          <div className="relative z-10 w-full h-full flex flex-col items-center justify-between p-10 py-16">
            ...
            <div className="text-center space-y-3 animate-item">
              <h2 className="text-4xl lg:text-5xl font-bold text-[#FBE4D8] tracking-tight">Join Upzy</h2>
        ...
        <div className="flex flex-col justify-center p-6 md:p-12 lg:p-20 space-y-6 overflow-y-auto hide-scrollbar">
          <div className="space-y-2 animate-item max-w-md w-full mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#522B5B]/5 border border-[#522B5B]/10 mb-1">
              <span className="text-[10px] font-bold text-[#522B5B] uppercase tracking-[0.2em]">Get Started</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold text-[#190019] tracking-tight">Create Account</h1>
            <p className="text-[#854F6C]/80 font-medium text-base">Join our community of innovators</p>
          </div>
          ...
          <form className="space-y-7 max-w-md w-full mx-auto mt-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button 
              type="submit"
              className="w-full bg-[#2B124C] hover:bg-[#190019] text-[#FBE4D8] font-bold py-4 rounded-full shadow-lg shadow-[#2B124C]/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group mt-4 overflow-hidden relative"
            >
          ...
          <div className="space-y-6 animate-item max-w-md w-full mx-auto">
            <p className="text-center text-[#854F6C] text-sm font-medium">
              Already a member?{' '}
              <Link to="/login" className="text-[#2B124C] font-bold hover:underline transition-all">Sign in here</Link>
            </p>

            <div className="relative">
              <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-[#DFB6B2]"></div></div>
              <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest"><span className="bg-[#FBE4D8] px-4 text-[#854F6C]">Quick Connect</span></div>
            </div>
